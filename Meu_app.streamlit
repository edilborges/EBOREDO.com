...
codigos_validos = ["INF2025", "ABC123", "EDIL", "edil"]
...
if opcao == "Cadastrar":
    ...
    if st.button("Entrar"):
        if usuario in usuarios and usuarios[usuario] == senha:
            ...
            # 🔗 Link para o material após login
            st.markdown("[📘 Clique aqui para acessar o Guia de Estudos Python](https://www.empowerdata.com.br/material-yt-guia-estudos-python)")

            # ✅ Somente o admin "Borges" pode ver os acessos
            if usuario == ADMIN:
